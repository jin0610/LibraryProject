    ...
    return(
        <div className="mt-lg-12 mb-lg-14 mb-8">
            <div className="container">
                <div className="row">
                    <BookListSidebar/>
                    <section className="col-xl-9 col-md-12">
                        <div className="g-4 mt-2 row row-cols-xl-3 row-col-lg-3 row-cols-md-2 row-cols-2">
                            {/* <!-- book1 --> */}
                            <div className="col book-card-row">
                                <div className="card h-100">
                                    {/* <!-- book Image --> */}
                                    <div className="text-center position-relative booklist-card-image">
                                        <div className=" mx-3 position-absolute top-0 start-0">
                                            <span className="badge bg-success">판매중</span>
                                        </div>
                                        <a href="#">
                                            <img src="https://library.kbu.ac.kr/libeka/fileview/f6ec917f-d09b-4f09-9061-9fe6d8ab25ee.JPG" alt="" className="card-img"/>
                                        </a>
                                    </div>
                                    {/* <!-- book Info --> */}
                                    <div className="p-3 booklist-card-Info-group">
                                        <h2 className="fs-6 text-decoration-none">
